  ...
  showModalBottomSheet(
    ...
    builder: (BuildContext context) {
      return FractionallySizedBox(
        heightFactor: 0.6, // Adjust this value to control the height of the bottom sheet
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<NotificationResponse>>(
        future: IncidentClient().getAllNotifications(perpage: 10, page: 1, context: context),
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                child: GestureDetector(
                  onTap: () {
                    _showFullMessageBottomSheet(context, notifications[index].message);
                  },
                  child: Text(
                   
                    showFullMessage ? notifications[index].message : _truncateMessage(notifications[index].message),
                  ),
                ),
              ),),
